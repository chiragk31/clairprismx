...
import { Check, X, Loader2, ExternalLink, RefreshCcw } from 'lucide-react';
...
const PLAN_FEATURES = {
    free: [
        { name: "Up to 2 repositories", included: true },
        ...
        return (
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        No user data found. Please log in to view subscription plans.
                    </p>
                </div>
                <Alert variant="destructive">
                    <AlertTitle>Error</AlertTitle>
    ...
    return (
        <div className="space-y-6">
            <div className='flex items-center justify-between'>
                ...
                >
                    {syncLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : <RefreshCcw className='h-4 w-4 mr-2' />}
                    Sync Status
                </Button>
            ...
            {success === "true" && (
                <Alert className="border-green-500 bg-green-50 dark:bg-green-950">
                    ...
                    <AlertDescription>
                        Your subscription has been updated successfully. Changes may take a few
                        moments to reflect.
                    </AlertDescription>
                </Alert>
            )}
